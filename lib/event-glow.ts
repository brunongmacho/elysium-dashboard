...
/**
 * Calculates dynamic glow properties based on time remaining for events
 * Similar to boss glow but optimized for shorter event timelines
 */
export function calculateEventGlow(timeRemaining: number | null): GlowResult {
  ...
  // Event has started or passed - maximum intensity danger
  ...
  // Very soon: 5-15 minutes - Blend danger to accent-dark
  if (minutesRemaining < 15) {
    const factor = (minutesRemaining - 5) / 10; // 0 to 1
  ...
  // Soon: 15-30 minutes - Blend accent-dark to accent
  if (minutesRemaining < 30) {
    const factor = (minutesRemaining - 15) / 15; // 0 to 1
  ...
  // Approaching: 30-60 minutes - Pure accent
  ...
  // Medium-close: 1-2 hours - Blend accent to accent-light
  ...
  // Medium: 2-4 hours - Blend accent-light to primary-dark
  ...
  // Medium-far: 4-8 hours - Blend primary-dark to primary
  ...
  // Far: 8-24 hours - Blend primary to primary-light
  ...
  // Very far: >24 hours - Subtle primary-light glow
  return {
    color: primaryLight,
    intensity: 4,
